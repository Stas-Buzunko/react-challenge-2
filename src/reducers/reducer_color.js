import { FETCH_COLORS, CHANGE_EXPORT_TYPE, CHANGE_EXAMPLES, COLOR_CHANGE, TEXT_COLOR_CHANGE, TOGGLE_BACKGROUND, TOGGLE_COLOR_PICKER_VISIBILITY  } from '../actions/index';

const INITIAL_STATE = { export_type:'Sass' ,schemes: {aspirin:[],  bird:[], firenze:[], honey:[] , retromatic:[]}, flat: [], material:[], examples: [], COLOR: '', darkBackgroundDarker:false, darkBackgroundMixed:false, colorPickerVisible: false };
