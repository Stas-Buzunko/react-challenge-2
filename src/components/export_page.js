...
import ExportLink from './export_page/export_link';
	...
	componentWillMount(){
		if (this.props.selectedSamples.length !== undefined) {
			...
			this.props.selectedSamples.map((sample) => {
				...
				modifiedSamples.push({hex: sample, value: `color-${i}`, rgb: `rgb(${R}, ${G}, ${B})`});
				...
				return (
						...
						<td>
							<input 
								...
								type="text" 
								value={sample.value}
								onChange={event => this.handleChange(sample,event.target.value)}
							/>
						</td>
					</tr>
				);
		...
		return (
			<div className="content">
				<div className="export container">
					<h1><strong>Customize and Export colors for Sass, Less or Stylus</strong></h1>
					...
					<div style={{display: `${this.props.selectedSamples.length ? 'block' : 'none'}`}}>
						<h2 className="export__title">Export your code</h2>
						<div className="preprops__links">
							<ExportLink changeExportType={this.props.changeExportType} currentType={this.props.export_type}>Sass</ExportLink>
							<ExportLink changeExportType={this.props.changeExportType} currentType={this.props.export_type}>Less</ExportLink>
							<ExportLink changeExportType={this.props.changeExportType} currentType={this.props.export_type}>Stylus</ExportLink>
						</div>
...
export default connect(mapStateToProps, {modifySamples, changeExportType})(ExportPage)